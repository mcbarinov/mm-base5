...
@router.get("/")
def system_page(render: RenderDep, core: CoreDep) -> HTMLResponse:
    return render.html("system.j2", stats=core.system_service.get_stats())


@router.get("/dconfigs")
def dconfigs_page(render: RenderDep, core: CoreDep) -> HTMLResponse:
    return render.html("dconfigs.j2", info=core.system_service.get_dconfig_info())


@router.get("/dconfigs/toml")
def dconfigs_toml_page(render: RenderDep, core: CoreDep) -> HTMLResponse:
...
def dconfigs_multiline_page(render: RenderDep, core: CoreDep, key: str) -> HTMLResponse:
    return render.html("dconfigs_multiline.j2", dconfig=core.dconfig, key=key)


@router.get("/dvalues")
def dvalues_page(render: RenderDep, core: CoreDep) -> HTMLResponse:
    return render.html("dvalues.j2", info=core.system_service.get_dvalue_info())


@router.get("/dvalues/{key:str}")
def update_dvalue_page(render: RenderDep, core: CoreDep, key: str) -> HTMLResponse:
...
def update_dconfig(render: RenderDep, core: CoreDep, form: FormDep) -> RedirectResponse:
...
def update_dconfig_multiline(render: RenderDep, core: CoreDep, key: str, value: Annotated[str, Form()]) -> RedirectResponse:
...
def update_dconfig_from_toml(render: RenderDep, core: CoreDep, value: Annotated[str, Form()]) -> RedirectResponse:
...
def update_dvalue(render: RenderDep, core: CoreDep, key: str, value: Annotated[str, Form()]) -> RedirectResponse:
